  ...
  return (
    <main className="max-w-3xl mx-auto px-6 py-10 text-gray-800 dark:text-gray-100">
      ...
      <ul className="list-disc pl-6 space-y-2">
        <li>
          Always verify enrollment details in the official college portal.
        </li>
        <li>
          Do not rely on this app as the sole source of class availability
          information.
        </li>
        <li>
          Use of the service may be limited to approved institutional accounts.
        </li>
      </ul>
    </main>
  );
